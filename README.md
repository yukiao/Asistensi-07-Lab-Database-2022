...
Repositori untuk pengumpulan Tugas Praktikum Asistensi 07 Basis Data 2022 Sistem Informasi Universitas Hasanuddin
...
- Pindah ke repositori hasil clone dengan perintah berikut
  ```
  cd Asistensi-07-Lab-Database-2022
  ```
...
- Di dalam folder pertemuan tersebut, kalian menambahkan file tugas praktikum yang telah kalian kerjakan dengan format nama file "assignment_<_no pertemuan_>_<_no_soal_>.sql" tanpa tanda kutip
